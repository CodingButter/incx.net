        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-baseline mb-4">
              <span className="text-2xl font-bold text-white">INCX</span>
              <span className="text-2xl text-gray-400">.net</span>
            </div>
            <p className="text-gray-400 mb-4">
              Enterprise hosting solutions since {config.company.founded}. Dedicated servers, VPS, and colocation services.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/InterConnecX/"
                target="_blank"
              ...
              <a
                href="https://twitter.com/interconnecx"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
              ...
              <a
                href="https://www.linkedin.com/company/interconnecx"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
              ...
              <a
                href="https://github.com/interconnecx"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-center md:text-left mb-4 md:mb-0">
              © {currentYear} {config.company.name}. All rights reserved. | AS13737
            </p>
          ...
          <div className="text-center mt-6 text-sm text-gray-400">
            Powered by <a href="https://codingbutter.com" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 transition-colors">CodingButter LLC</a>
          </div>
        </div>
      </div>
    </footer>
